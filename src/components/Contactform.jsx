  ...
  return (
    <div>
      <div className="  border  w-11/12 md:w-4/6 lg:w-3/6 text-center pt-8  m-auto bg-slate-200 rounded-2xl">
        <form className=" p-3 md:p-5 m-auto">
          ...
          <div className="submmit mb-5 mt-5">
            <button
              type="submmit"
              className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-9/12 md:w-2/6"
